            ...
            <ImageBackground style={{width:"100%", flex: 1}} source={require("../assets/fondoVioleta.png")} resizeMode="cover">
                ...
                <View style={styles.container}>
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <Text style={[styles.title, {color: "#67f2cb",marginLeft:5}]}> wishlist!</Text>
                    </View>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <Text style={styles.title}>Don't have</Text>
                        <Text style={[styles.title, {color: "#67f2cb",marginLeft:5}]}>one?</Text>
                    </View>
