...
import { ImageBackground, Text, View, Image, TextInput, TouchableOpacity, ScrollView, StyleSheet} from "react-native"
...
const Profile = () => {
   ...
   let addAddress= !directions || directions.length === 0 ? "Add Address": "Add another address"
        ...
        <ScrollView>
         <ImageBackground style={{width:"100%", minHeight:400, alignItems:"center"}} source={{uri: "https://i.postimg.cc/3wVXYt59/back-Ludo3.png"}}>
            ...
            <View style={{flexDirection:"row", justifyContent:"center", alignItems:"center", marginVertical:15}}>
                 <Image style={{width:50, height:50, borderRadius:50}} source={{uri: photo}}/> 
            ...
            <View>
                    <View style={{flexDirection:"row", alignItems:"center"}}>
                        <Text style={{ color:"white", fontFamily:'Poppins_600SemiBold', fontSize:15}}>Phone number:</Text>
                        <Text style={{marginLeft:10, color:"white", fontFamily:'Poppins_600SemiBold', fontSize:12}}>{userPhone}</Text>
                    </View>
                    <View>
                        {visiblePhone && (
                            <>
                                <ImageBackground style={styles.userButton} source={{ uri: "https://i.postimg.cc/mD7r09R8/button-Back.png" }} imageStyle={{borderRadius:5}}>
                                <Text style={{ color:"white", fontFamily:'Poppins_600SemiBold', alignSelf:"center", fontSize:10}}>Add phone number</Text>
                                </ImageBackground>
                        ...
                        {!visiblePhone && (
                            <TouchableOpacity
                                onPress={() => setVisiblePhone(!visiblePhone)}>
                                     <ImageBackground style={styles.userButton} source={{ uri: "https://i.postimg.cc/mD7r09R8/button-Back.png" }} imageStyle={{borderRadius:5}}>
                                     <Text style={{ color:"white", fontFamily:'Poppins_600SemiBold', alignSelf:"center", fontSize:10}}>{editPhone}</Text>
                                    </ImageBackground>
                        ...
                        <View >
                            <View style={{flexDirection:"row", alignItems:"center"}}>
                                <Text style={{ color:"white", fontFamily:'Poppins_600SemiBold', fontSize:15, marginRight:15}}>Addresses:</Text>
                                <View>
                                    {!directions || directions.length === 0 ? (
                                    <Text style={{ color:"white", fontFamily:'Poppins_600SemiBold', fontSize:12}}>There are no addresses added</Text>
                                    ) : (
                            ...
                            <View>
                                <TouchableOpacity onPress={() => setVisibleDirectionForm(!visibleDirectionForm)}>
                                    <ImageBackground style={styles.userButton} source={{ uri: "https://i.postimg.cc/mD7r09R8/button-Back.png" }} imageStyle={{borderRadius:5}}>
                                        <Text style={{ color:"white", fontFamily:'Poppins_600SemiBold', alignSelf:"center", fontSize:10}}>{addAddress}</Text>
                                    </ImageBackground>
                                </TouchableOpacity>
                            </View>
