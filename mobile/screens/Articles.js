                ...
                <View style={styles.articlesMain}>
                    ...
                    {articles?.totalPages > 1 && (
                        <View style={styles.paginationButtonContainer} >
                            {currentPage > 1 && (
                                <TouchableOpacity style={styles.prevButton} onPress={() => { setCurrentPage(currentPage - 1); scrollRef.current?.scrollTo({y:0, animated:true}); }} >
                                    <Text style={styles.prevText}>Prev</Text>
                                </TouchableOpacity>
                            )}
                            <TouchableOpacity style={styles.numberPage} >
                                <Text style={styles.numberText} >Current page: {currentPage}/{articles.totalPages}</Text>
                            </TouchableOpacity>
                            {currentPage < articles.totalPages && (
                                <TouchableOpacity style={styles.nextButton} onPress={() => { setCurrentPage(currentPage + 1); scrollRef.current?.scrollTo({y:0, animated:true}); }} >
