    ...
    return(
        <div className="bodyArticle" style={{backgroundImage: `url("https://i.postimg.cc/zDhycDV6/fondoblanco2.png")`}}>
            ...
            <div className="articleDecoUp">
                {/* <div className="articleDeco" style={{backgroundImage: `url("https://i.postimg.cc/R0nzL4hc/codex-Deco1.png")`}}></div> */}
                <div className="articleDeco" style={{backgroundImage: `url("https://i.postimg.cc/t4FF8VsJ/codex-Deco2.png")`}}></div>
            </div>
           ...
           <div className="articleDecoDown">
                 <div className="articleDeco" style={{backgroundImage: `url("https://i.postimg.cc/SxGHkR5Q/codex-Deco3.png")`}}></div>
