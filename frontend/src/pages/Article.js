    ...
    return(
        <div className="bodyArticle" style={{backgroundImage: `url("https://i.postimg.cc/zDhycDV6/fondoblanco2.png")`}}>
           ...
           <div className="articleDecoRight">
            ...
            <div>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/3Ln6yqmoCpE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <Footer/>
        </div>
    )
