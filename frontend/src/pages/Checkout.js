      ...
      <div className="d-flex flex-column justify-content-center align-items-center">
        <div className="checkoutContainer">
          ...
          <div>
              ...
              return (
                ...
                >
                  ...
                  <div className="rightCheckout d-flex">
                    <h4 className="pe-5">
                      x <span className="textQuantity">{article.quantity}</span>
                      u
                    </h4>
            ...
            <div>
              <p>
                Street: {direction.street} - State: {direction.state} - City:{" "}
                {direction.city}
              </p>
              <p>
                Number: {direction.number} - Department: {direction.department}{" "}
                - Zip Code: {direction.zipCode}
              </p>
