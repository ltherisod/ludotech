        ...
        <div className="mostWantedConteiner">
            ...
            <div className="mostWantedCard" style={{backgroundImage: "url('https://i.postimg.cc/5yHSybcS/card-Style56left.png')"}}>
                <div className="mostWantedGameConteiner" >
                    ...
                    <div className="mostWantedGame" style={{backgroundImage: `url('${mostVisitArticles[0].photos[0]}')`}}></div>
                </div>
            </div>
            <div className="mostWantedCard" style={{backgroundImage: "url('https://i.postimg.cc/D0zYct9S/card-Style56.png')"}}>
                <div className="mostWantedGameConteinerLeft" >
                    <div className="mostWantedGame" style={{backgroundImage: `url('${mostVisitArticles[1].photos[0]}')`}}></div>
