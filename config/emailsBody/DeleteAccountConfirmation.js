const DeleteAccountConfirmation = (data) => {
  return `<body style="margin: 0;padding: 0;box-sizing: border-box;font-family:Poppins,sans-serif;text-decoration: none;background-color:#8646d4">
    ...
    <main style="width:80vw;margin:0 auto;">
      ...
      <p style="font-size:1.2rem">Are you sure you want to delete your user account?.</p>
      <p>Please click here to confirm that you want to <span style="font-size:1.2rem;color:#542b86;text-decoration:underline;"><a href="http://localhost:3000" >delete your account</a></span>.</p>
      <br/>
    </main>
    <footer style="">
...
module.exports = DeleteAccountConfirmation