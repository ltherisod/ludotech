const ConfirmationEmail = (data) => {
  return `<body style="margin: 0;padding: 0;box-sizing: border-box;font-family:Poppins,sans-serif;text-decoration: none;background-color:#8646d4">
    ...
    <main style="width:80vw;margin:0 auto;">
      ...
      <p>Please click here to <span style="font-size:1.2rem;color:#542b86;text-decoration:underline;"><a href="https://lodotechgames.herokuapp.com" >Confirm your e-mail</a></span> for your account.</p>
      <br/>
